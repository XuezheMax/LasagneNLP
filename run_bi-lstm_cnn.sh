THEANO_FLAGS='floatX=float32' python bi_lstm_cnn.py --fine_tune --embedding glove --oov embedding --update mementum --batch_size 10 --num_units 100 --num_filters 20 --grad_clipping 0 --regular none \
