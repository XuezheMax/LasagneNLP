THEANO_FLAGS='floatX=float32' python parser.py --mode parse --embedding random --update momentum \
 --batch_size 10 --num_units 200 --num_filters 30 --momentum 0.9 --grad_clipping 5 --regular none \
 --learning_rate_bottom 0.01 --decay_rate_bottom 0.05 --learning_rate_top 0.01 --decay_rate_top 0.05 \
