THEANO_FLAGS='floatX=float32' python bi_rnn_cnn.py --fine_tune --embedding glove --oov embedding --update momentum --batch_size 10 --num_units 100 --num_filters 20 --grad_clipping 3 --regular dropout \
