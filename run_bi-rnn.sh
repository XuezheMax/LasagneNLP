THEANO_FLAGS='floatX=float32' python bi_rnn.py --fine_tune --embedding senna --oov embedding --update momentum --batch_size 10 --num_units 100 --grad_clipping 3 --regular none \
